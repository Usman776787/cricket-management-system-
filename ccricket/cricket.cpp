...
public:
	...
	choice:
		...
		cout << "Alright, So it's a battle between \n"
			 << team1 << "   VS   " << team2 << endl
			 << endl;
		cout << "Lets's move on to the toss!!!" << endl
			 << endl;
		choice = 0;
	...
	void startinnings()
	{
		...
		select:
			...
			while (out < 10 && over < maxovers)
			{
				...
				cout << endl
					 << "WICKETS: " << out << endl;
				cout << endl
					 << "BALLS LEFT: " << maxballs << endl;
				towin = target - totalscore;
				if (innings == 2)
				{
					cout << endl
						 << "TO WIN " << bowl << " need " << towin << " runs in " << maxballs << endl;
				}
				...
				if ((ball - 1) % 6 == 0 && ball > 5)
				{
					...
					cout << endl
						 << "Total score: " << totalscore << endl;
					cout << endl
						 << "Runs scored this over: " << overscore << endl;
					cout << endl
						 << "Total overs played: " << over << endl
						 << endl;
					cout << endl
						 << "Total wickets fallen: " << out << endl
						 << endl;
					cout << endl
						 << "Extras: " << extras << endl
						 << endl;
		...
		p:
			if (innings == 1)
			{
				...
				target = totalscore + 1;
				cout << endl
					 << bowl << " has to score " << target << " runs in " << maxovers << " overs." << endl
					 << endl;
				cout << endl
					 << "Total balls played: " << totalballs << endl
					 << endl;
				cout << endl
					 << "Total wickets fallen: " << out << endl
					 << endl;
			...
			else if (innings == 2)
			{
				...
				if (totalscore >= target)
				{
					cout << endl
						 << endl
						 << bowl << " HAS WON THE MATCH WITH " << rmnwkt << " WICKETS LEFT !!!\n\n";
				}
				else
				{
					cout << endl
						 << endl
						 << bat << " HAS WON THE MATCH BY " << towin << " RUNS !!!\n\n";
				}
